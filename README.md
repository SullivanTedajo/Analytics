# Analytics
Un template de dashboard 
# Objet
Le but du travail pratique est de réaliser un template d'un dashboard. Cet exercice s'inscrit dans mon auto-formation en tant que developpeur Front-end.
# Technologies
